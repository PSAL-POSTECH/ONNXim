...
RUN yum update -y && yum install -y python3 python3-pip git wget gcc gcc-c++ make openssl-devel libasan libubsan
...
RUN pip3 install conan==1.57.0 onnx torch torchvision
